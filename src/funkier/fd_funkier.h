...
struct __attribute__((aligned(FD_FUNKIER_ALIGN))) fd_funkier_private {
  ...
  /* The funk transaction map stores the details about transactions
     ...
     fd_map_giant and more details are given in fd_funkier_txn.h
     ...
     modified.  Will be FD_FUNKIER_TXN_IDX_NULL if txn_max is zero.
  ...
  /* The funk record map stores the details about all the records in
     ...
     is a fd_map_giant and more details are given in fd_funkier_txn.h
...
/* fd_funkier_{align,footprint} return FD_FUNKIER_{ALIGN,FOOTPRINT}. */
